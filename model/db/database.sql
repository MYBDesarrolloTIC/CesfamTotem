...
INSERT INTO pacientes (rut, nombres, apellido_p, apellido_m, fecha_nacimiento, edad, estado, es_preferente) VALUES
    ...
    ('44444444-4', 'Lucía',        'Vega',     'Castillo', '1961-09-09', 63, 1, TRUE),  -- adulto mayor
...
INSERT INTO tickets (numero, letra, id_paciente, id_tipo_atencion, id_modulo, id_estado, veces_llamado, fecha_creacion) VALUES
    -- Turno actualmente LLAMADO en SOME 1
    (1, 'A', 1, 1, 1, 2, 1, NOW() - INTERVAL 18 MINUTE),
    -- Cola ESPERANDO (sin módulo asignado aún)
    (2, 'A', 3, 1, NULL, 1, 0, NOW() - INTERVAL 15 MINUTE),
    (3, 'A', 2, 1, NULL, 1, 0, NOW() - INTERVAL 12 MINUTE),  -- preferencial
    (4, 'A', 5, 1, NULL, 1, 0, NOW() - INTERVAL 10 MINUTE),
    (5, 'A', 7, 1, NULL, 1, 0, NOW() - INTERVAL  7 MINUTE),
    (6, 'A', 4, 1, NULL, 1, 0, NOW() - INTERVAL  5 MINUTE),  -- preferencial
    -- Un turno SALTADO anterior
    (7, 'B', 3, 2, 3, 3, 2, NOW() - INTERVAL 40 MINUTE);
...
INSERT INTO turnos_actuales (ticket_numero, es_preferencial, modulo_atencion, box_asignado, estado, fecha_llamado) VALUES
    ('A-001', FALSE, 'SOME', 'SOME 1', 'llamado', NOW() - INTERVAL 3 MINUTE);
